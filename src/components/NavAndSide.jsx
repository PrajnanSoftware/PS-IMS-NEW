...
const NavAndSide = () => {
    return (
        <div className="flex">
            <div className="bg-[#0A2240] h-screen w-80 p-5 fixed rounded-lg">
                <NavLink to="/" className="flex items-center mt-5 mb-5 ml-12">
                    <PiCubeFocusFill className="text-[#1570EF] text-4xl mr-2" />
                    <span className="text-[#1570EF] text-2xl">Dashboard</span>
                </NavLink>
                <nav>
                    <NavLink className={({ isActive }) =>
                        `${isActive ? 'text-white' : 'text-[#949494]'} flex items-center p-4 hover:text-white transition duration-300 mt-10 ml-14`}
                        to="/">
                        <IoSpeedometer className="text-[#1570EF] text-2xl mr-2" />
                        <span>Dashboard</span>
                    </NavLink>
                    <NavLink className={({ isActive }) =>
                        `${isActive ? 'text-white' : 'text-[#949494]'} flex items-center p-4 hover:text-white transition duration-300 mt-5 ml-14`}
                        to="/stock">
                    ...
                    <NavLink className={({ isActive }) =>
                        `${isActive ? 'text-white' : 'text-[#949494]'} flex items-center p-4 hover:text-white transition duration-300 mt-64 ml-14`}
                        to="/settings">
                        <IoSettingsOutline className="text-[#1570EF] text-2xl mr-2" />
                        <span>Settings</span>
                    </NavLink>
                    <NavLink className={({ isActive }) =>
                        `${isActive ? 'text-red-600' : 'text-[#FF0000]'} flex items-center p-4 hover:text-red-800 transition duration-300 mt-4 ml-14`}
                        to="/logout">
            ...
            <div className="flex-1 ml-80 bg-white fixed w-10/12">
