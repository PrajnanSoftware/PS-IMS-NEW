                            ...
                            <tbody>
                                {currentItems.map((order, index) => (
                                    <tr key={order._id}>
                                        ...
                                        <td className="py-2 px-4 border-b text-center">₹{order.orderValue}</td>
                                        ...
                                        <td className="py-2 px-4 border-b text-center">{new Date(order.dateOfDelivery).toLocaleDateString()}</td>
