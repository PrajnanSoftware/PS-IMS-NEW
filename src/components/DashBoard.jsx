...
const DashBoard = () => {
    ...
    // Set up Charts once we have dashboardData
    useEffect(() => {
            ...
            barChart = new Chart(barCtx, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: 'Overview',
                            data: [salesObj.sales || 0, purchaseObj.purchase || 0],
    ...
    if (loading) return <div className="mt-20 ml-[210px]">Loading dashboard...</div>;
    if (error) return <div className="mt-20 ml-[210px] text-red-500">Error: {error}</div>;
    if (!dashboardData) return <div className="mt-20 ml-[210px]">No dashboard data available.</div>;

    // Extract data to display in cards / tables
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    ...
                    <div className="flex justify-around items-center">
                        <div className="text-center justify-items-center">
                            ...
                            <p className="text-xl font-semibold">{inventory.quantityInHand ?? 0}</p>
                            <p className="text-gray-500">Quantity in Hand</p>
                        </div>
                        <div className="text-center justify-items-center">
                            <FaTruck className="text-2xl text-purple-500" />
                            <p className="text-xl font-semibold">{inventory.toBeReceived ?? 0}</p>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    ...
                    <div className="flex justify-around items-center">
                        <div className="text-center justify-items-center">
                            ...
                            <p className="text-xl font-semibold">{productSummary.numberOfSuppliers ?? 0}</p>
                            <p className="text-gray-500">Number of Suppliers</p>
                        </div>
                        <div className="text-center justify-items-center">
                            <FaList className="text-2xl text-purple-500" />
                            <p className="text-xl font-semibold">{productSummary.numberOfCategories ?? 0}</p>
